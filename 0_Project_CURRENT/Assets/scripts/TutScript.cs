	...
	void Update ()
	{
		...
		if (progressable == 1) {
			if (whichTut == "controls") {
				...
				} else if (tutProgress == 1 && ship.stats.lv.z > 50)
					tutProgress = 2;
				else if (tutProgress == 2 && ship.stats.lv.z <= 40) {
					tutProgress = 3;
					nexty (2, 0.5f);
				} else if (tutProgress == 3 && ship.stats.jumps == 2) {
					tutProgress = 4;
					nexty (4, 0.5f);
				} else if ((tutProgress == 4) && (Mathf.Abs (ship.stats.lv.x) > 16)) {
					tutProgress = 5;
					nexty (6, 0);
				}
				...
				if (tutProgress == 0 && ship.stats.grounded) { 
